...
export default function AdminSettingsPage() {
  ...
  if (loading) return <main style={styles.page}>Loading settings...</main>;
  ...
  return (
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <p style={styles.text}>Control future platform rules and admin tools.</p>
      </section>

      <section style={styles.card}>
        <h2>Current Admin</h2>
        <p>meerhamzakhan2020@gmail.com</p>

        <h2>Advertising Rule</h2>
        <p>Paid ads run for 30 days after approval.</p>

        <h2>Approval Rule</h2>
        <p>All ads require admin review before appearing live.</p>
      </section>
    </main>
  );
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  text: { color: "#5f6b66" },
  card: { maxWidth: 1100, margin: "0 auto", background: "#fff", padding: 26, borderRadius: 24 },
};